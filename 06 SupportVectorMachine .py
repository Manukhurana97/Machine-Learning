# Basic of svm(Support vector machines) for the cancer detection 
...
X = np.array(df.drop(['class'], 1)) #  X= feature :- everything except class column
y = np.array(df['class']) # y= label :- clss column
